...
## This is an application for tracking workouts built using MongoDB and the Mongoose npm package. It is structured with MVC, and uses Node, Express, and MongoDB Atlas (for hosting on Heroku).
...
[Click here to see the Fitness Tracker!](https://floating-springs-76073.herokuapp.com/)
